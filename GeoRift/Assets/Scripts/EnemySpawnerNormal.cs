...
public class EnemySpawnerNormal : MonoBehaviour, IEnemySpawner
{
    public static EnemySpawnerNormal Instance { get; private set; }
    public int CurrentWave { get { return WaveToSpawn; } }
    ...
    void OnDestroy()
    {
        EnemySpawnerRegistry.Unregister(this);
    }
    ...
    IEnumerator GameLoop()
    {
        ...
        GameManager.Instance.Player.transform.parent.gameObject.SetActive(false);
